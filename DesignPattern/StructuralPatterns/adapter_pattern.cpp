...
From a real-world example, I have a mobile phone and a charger to charge the phone.
But, the problem is the charger is a round-pin charger where the mobile supports flat-pin
charger. So, to solve the problem, I need an adapter(converter) which will allow me
...
public:
	void flat_pin() {
		std::cout << "I only support flat pin charger!!!" << std::endl;
	}
};
...
int main()                                                        // client code, charger -> I only support round pin
{
